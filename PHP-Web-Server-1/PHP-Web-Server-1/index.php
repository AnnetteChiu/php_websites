...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            ...
            <body>
              <div class="container">
                <h1 class="text-center">Submitted Messages</h1>
                <?php if (!empty($submissions)): ?>
                  <?php foreach ($submissions as $submission): ?>
                    <div class="message">
                      <p><strong>Customer:</strong> <?php echo htmlspecialchars($submission['message']); ?></p>
        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                    <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0" src="demo-image-01.jpg" alt="..." /></div>
                ...
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="demo-image-03.jpg" alt="..." /></div>
                    <div class="col-lg-6">
